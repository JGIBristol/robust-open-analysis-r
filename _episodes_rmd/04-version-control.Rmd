...
In the Git pane in RStudio, click the icon that looks like a clock to open the "View history of previous commits".

A new "Review Changes" window will open. You will be able to see (from left to right)
- A tree diagram, each dot is a a commit (i.e. a snapshot), 
