...
> In older (pre-BLM) Git repositories you will see the that the `main` branch is often called the `master` branch - this is the same thing. And you will also see this terminology used in a lot of online tutorials that haven't been updated yet. Thankfully the tech community is now moving away from this terminology.
{: .callout}
