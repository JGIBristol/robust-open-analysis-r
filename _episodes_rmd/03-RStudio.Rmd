...
> 1. Type `y <- r` in the `test.R` file on a new line. 
...
> 5. You should have `y <- runif()` automatically typed out. 
...
> 8. Make sure the `n = ` is highlighted and hit enter <kbd>Enter</kbd>, type `10`, your line should now look like `y <- runit(n=10)`. 
...
> 4. Type 'I love R'. Click <kbd>Esc</kbd> to stop multiline editing. 
...
> 6. Switch to the console and save the image by typing `save.image(file='semicircle.png')`
{: .challenge}
